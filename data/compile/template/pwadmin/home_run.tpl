...
<div class="wrap">
	...
	<div class="home_info">
		<ul>
			<li>
				<em>软件版本</em>
				<span><?php echo htmlspecialchars($sysinfo['wind_version'], ENT_QUOTES, 'UTF-8');?> <a href="http://www.phpwind.com/product.html" target="_blank">查看最新版本</a></span>
			</li>
			<!-- 
			<li>
				<em>操作系统</em>
...
//获取升级信息通知
$.ajax({
    url: "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=pwadmin&c=home&a=notice'; ?>",
    dataType: "json",
