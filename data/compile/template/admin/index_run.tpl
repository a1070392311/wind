	...
	<body>
		<div class="wrap">
			...
			<table width="100%" height="100%" style="table-layout:fixed;">
				<tr class="head">
					<th><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?'; ?>" class="logo">管理中心</a></th>
					<td>
					<div class="nav">
					...
					<div class="login_info">
						<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/',''; ?>" class="home" target="_blank">前台首页</a><span class="mr10">管理员： <?php echo htmlspecialchars($loginUser->username, ENT_QUOTES, 'UTF-8');?></span><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?a=logout'; ?>" class="mr10">[注销]</a>
					</div></td>
				</tr>
				<tr class="tab">
					<th>
					<div class="search">
						...
						<button type="button" name="keyword" id="J_search" value="" data-url="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?c=find'; ?>">搜索</button>
					</div></th>
					<td>
				...
				<tr class="content">
					...
					<td id="B_frame">
						...
						<iframe id="iframe_default" src="<?php echo htmlspecialchars(WindUrlHelper::createUrl(Wekit::app()->homeLink), ENT_QUOTES, 'UTF-8');?>" style="height: 100%; width: 100%;display:none;" data-id="default" frameborder="0" scrolling="auto"></iframe>
					</td>
				</tr>
			</table>
		</div>
...
var USUALL = [], /*常用的功能模块*/
	...
	SUBMENU_CONFIG = <?php echo WindSecurity::escapeEncodeJson($menus, 'UTF-8');?>,/*主菜单区*/
...
$(function(){
	...
	$.each(SUBMENU_CONFIG,function(i,o) {
        ...
        html.push('<li><a id="aliyun" href="http://market.aliyun.com/products/?spm=5176.9000004.0.0.YiHPLj&tag=phpwind" target="_blank" style="outline:0">云平台</a></li>');
