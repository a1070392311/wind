...
REPLACE INTO `pw_common_config` (`name`, `namespace`, `value`, `vtype`, `description`) VALUES ('goodRecommend', 'freshSetting', '1', 'string', NULL);
REPLACE INTO `pw_common_config` (`name`, `namespace`, `value`, `vtype`, `description`) VALUES ('hotTopic', 'freshSetting', '1', 'string', NULL);
REPLACE INTO `pw_common_config` (`name`, `namespace`, `value`, `vtype`, `description`) VALUES ('lifeService', 'freshSetting', '1', 'string', NULL);
REPLACE INTO `pw_common_config` (`name`, `namespace`, `value`, `vtype`, `description`) VALUES ('sameCity', 'freshSetting', '1', 'string', NULL);

INSERT INTO `pw_common_emotion_category` (`category_id`, `category_name`, `emotion_folder`, `emotion_apps`, `orderid`, `isopen`) VALUES (2,'旺旺', 'wangwang', 'bbs', 0, 1);
INSERT INTO `pw_common_emotion` (`emotion_id`, `category_id`, `emotion_name`, `emotion_folder`, `emotion_icon`, `vieworder`, `isused`) VALUES
(27, 2, '闭嘴', 'wangwang', 'face_01.gif', 0, 1),
(28, 2, '握手', 'wangwang', 'face_02.gif', 0, 1),
(29, 2, '晕死', 'wangwang', 'face_03.gif', 0, 1),
(30, 2, '口水', 'wangwang', 'face_04.gif', 0, 1),
(31, 2, '神马', 'wangwang', 'face_05.gif', 0, 1),
(32, 2, '猪头', 'wangwang', 'face_06.gif', 0, 1),
(33, 2, '明白', 'wangwang', 'face_07.gif', 0, 1),
(34, 2, '心动', 'wangwang', 'face_08.gif', 0, 1),
(35, 2, '汗死', 'wangwang', 'face_09.gif', 0, 1),
(36, 2, '真弱', 'wangwang', 'face_10.gif', 0, 1),
(37, 2, '调皮', 'wangwang', 'face_11.gif', 0, 1),
(38, 2, '战斗', 'wangwang', 'face_12.gif', 0, 1),
(39, 2, '呕吐', 'wangwang', 'face_13.gif', 0, 1),
(40, 2, '流泪', 'wangwang', 'face_14.gif', 0, 1),
(41, 2, '亲亲', 'wangwang', 'face_15.gif', 0, 1),
(42, 2, '伤心', 'wangwang', 'face_16.gif', 0, 1),
(43, 2, '酷毙', 'wangwang', 'face_17.gif', 0, 1),
(44, 2, '不屑', 'wangwang', 'face_18.gif', 0, 1),
(45, 2, '得意', 'wangwang', 'face_19.gif', 0, 1),
(46, 2, '怕怕', 'wangwang', 'face_20.gif', 0, 1),
(47, 2, '扁你', 'wangwang', 'face_21.gif', 0, 1),
(48, 2, '鼓掌', 'wangwang', 'face_22.gif', 0, 1),
(49, 2, '嘿嘿', 'wangwang', 'face_23.gif', 0, 1),
(50, 2, '发怒', 'wangwang', 'face_24.gif', 0, 1),
(51, 2, '心碎', 'wangwang', 'face_25.gif', 0, 1),
(52, 2, '好强', 'wangwang', 'face_26.gif', 0, 1);